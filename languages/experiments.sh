...
expoert QUICK_PREPROCESSING=1
cd eng-cat-v1 && ./voc.sh && ./preprocess.sh && ./train.sh && ./export.sh
cd eng-cat-v2 && ./voc.sh && ./preprocess.sh && ./train.sh && ./export.sh
cd eng-cat-v3 && ./voc.sh && ./preprocess.sh && ./train.sh && ./export.sh
cd eng-cat-v4 && ./voc.sh && ./preprocess.sh && ./train.sh && ./export.sh
cd eng-cat-v5 && ./voc.sh && ./preprocess.sh && ./train.sh && ./export.sh
