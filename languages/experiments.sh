...
cd eng-cat-v1 && ./voc.sh && ./preprocess.sh && ./train.sh && ./export.sh && cd ..
echo "Experiment 1" > results.txt
cat eng-cat-v1/bleu.txt >> results.txt

cd eng-cat-v2 && ./voc.sh && ./preprocess.sh && ./train.sh && ./export.sh && cd ..
echo "Experiment 2" > results.txt
cat eng-cat-v2/bleu.txt >> results.txt

cd eng-cat-v3 && ./voc.sh && ./preprocess.sh && ./train.sh && ./export.sh && cd ..
echo "Experiment 3" > results.txt
cat eng-cat-v3/bleu.txt >> results.txt

cd eng-cat-v4 && ./voc.sh && ./preprocess.sh && ./train.sh && ./export.sh && cd ..
echo "Experiment 4" > results.txt
cat eng-cat-v4/bleu.txt >> results.txt

cd eng-cat-v5 && ./voc.sh && ./preprocess.sh && ./train.sh && ./export.sh && cd ..
