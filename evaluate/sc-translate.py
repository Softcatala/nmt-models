...
def main():
    print("Translates flores200 datasets using HuggingFace Facebook Softcatalà models")
    ...
    for pair_language in pair_languages:
        ...
        hypotesis_file = f"sc-translate/sc-flores200-{model_name}-{source_language}-{target_language}.{target_language}"
